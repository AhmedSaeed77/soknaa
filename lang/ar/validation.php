...
return [
   ...
   'required_if' => 'الحقل :attribute مطلوب في حال ما إذا كان :other يساوي :value.',
    // 'required_if' => 'يجب ارفاق ايصال الدفع',
    ...
    */
    ...
    'attributes' => [
        ...
        'order_id'              => 'الطلب',
        'acceptreject'          => 'القبول والرفض',
        'ticket_details_id'     => 'تفاصيل التذكره',
        'email'                 => 'الايميل',
        'copoune'               => 'الكوبون',
        'phone'                 => 'الهاتف',
        'counter'               => 'العدد',
        ...
        'type'                  => 'النوع',
        'is_adjacent'           => 'هل متجاور',
        'quantity'              => 'الكميه',
        'is_direct_sale'        => 'للبيع مباشره',
        'info'                  => 'معلومات التذكره',
        'info.*.image'          => 'صوره التذكره',
        'info.*.chair_number'   => 'رقم الكرسى',
        'info.*.row'            => 'رقم الصف',
        'accountnumber'         => 'رقم الحساب',
//        'image.required_if'     => 'صوره الايصال',
        ...
        'physique'                   => 'بنيه الجسم',
        'health_statuse'                   => 'الحاله الصحيه',
        'beard'                   => 'اللحيه',
        'prayer'                   => 'الصلاه',
        'smoking'                   => 'التدخين',
        'educational_level'                   => 'المستوى التعليمى',
        'financial_statuse'                   => 'الوضع المادى',
        'employment'                   => 'مجال العمل',
        'monthly_income'                   => 'الدخل الشهرى',
        'life_partner_info'                   => 'مواصفات شريك الحياه',
        'my_information'                   => 'نبذه عنى',
        'nickname'                   => 'اسم المستخدم',
        'child_num'                   => 'عدد الاطفال',
        'sex'                   => 'الجنس',
        'typemerrage'                   => 'نوع الزواج',
        'familysitiation'                   => 'الحاله الاجتماعيه',
